...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_65_2_right_mods(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                          LT(_FN2,KC_SPC),                 KC_RGUI, MO(1),              KC_LEFT, KC_DOWN,  KC_RIGHT, KC_P0,   KC_PDOT),

    [_FN] = LAYOUT_65_2_right_mods(
     ...
     /* ctrl     win      alt                              space                    command      fn                        left     down     right        0         .           */
        KC_TRNS, KC_TRNS, KC_TRNS,                          KC_TRNS,                KC_TRNS, KC_TRNS,              KC_TRNS,KC_VOLD,  KC_TRNS,   KC_TRNS,   KC_TRNS     ),


        [_FN2] = LAYOUT_65_2_right_mods(
     /*  esc      1        2        3        4       5       6       7       8       9         0        -         =     bkspc                       del           /         *       -   */
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,   KC_F10,  KC_F11,   KC_F12,  KC_DEL,                    KC_TRNS,   KC_PSLS, KC_PAST, KC_PMNS,
     /*  tab      Q        W        E        R        T      Y        U      I        O        P        [         ]        \                        7            8         9       +   */ 
        KC_TAB, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,  KC_TRNS, KC_BSLS,                    KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_PPLS,
     /*  caps     A       S        D        F        G      H        J      K        L        ;        '       enter                                4            5         6           */
        KC_CAPS, G(KC_A), G(KC_S), KC_TRNS, KC_UP,  KC_TRNS,KC_TRNS,KC_DOWN,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,  KC_TRNS,                              KC_PGUP,    KC_TRNS,   KC_TRNS,
     /* shift             Z         X        C         V       B        N       M        ,        .         /        shift                  up       1            2         3       enter*/
        KC_TRNS,          KC_TRNS,  G(KC_X), G(KC_C), G(KC_V), G(KC_B), KC_TRNS,KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,             KC_VOLU,  KC_PGDN,    KC_P2,   KC_P3,   KC_PENT,
     /* ctrl     win      alt                              space                    command      fn                        left            down      right                         0         .           */
        KC_TRNS, KC_TRNS, KC_TRNS,                          KC_TRNS,                KC_TRNS, KC_TRNS,                      (KC_LALT | KC_LSFT | KC_LEFT),KC_VOLD,  ((KC_LALT | KC_LSFT | KC_RIGHT))   , KC_TRNS, KC_TRNS)
};
