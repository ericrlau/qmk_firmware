...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_std_2_right_mods(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                          MT(MOD_LGUI,KC_SPC),                 G(KC_SPC), MO(1),              KC_LEFT, KC_DOWN,  KC_RIGHT, KC_P0,   KC_PDOT),

    [_FN] = LAYOUT_std_2_right_mods(
     ...
     /* ctrl     win      alt                              space                    command      fn                        left     down     right        0         .           */
        KC_TRNS, KC_TRNS, KC_TRNS,                          KC_TRNS,                KC_TRNS, KC_TRNS,              RALT(RSFT(KC_LEFT)),KC_VOLD,  RALT(RSFT(KC_RIGHT)),   KC_TRNS,   KC_TRNS     )
};
